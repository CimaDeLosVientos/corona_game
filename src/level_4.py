...
from .helpers import *
from .things import Salad, Soap, SpoiledSteak
...
class Level4Introduction(Scene):
    def __init__(self):
        ...
        self.chat = []
        self.chat.append(pygame.transform.scale(load_image("assets/images/scenes/4-0.png"), CHAT_SURFACE))
        self.current_chat = -1
...
class Level4Play(Scene):
    def __init__(self):
        Scene.__init__(self)
        self.music = "assets/music/01_-_Man.mp3"
        ...
        self.background = load_image("assets/images/scenes/kitchen.png")
        self.object_1_icon = Salad(OBJECT_1_ICON_LOCATION)
