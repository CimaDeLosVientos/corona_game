...
class Level5Play(Scene):
    def __init__(self):
        Scene.__init__(self)
        self.music = "assets/music/Phillip_Gross_-_02_-_Der_Ton_Macht_Die_Musik.mp3"
    ...
    def on_update(self, time):
        ...
        if pygame.mixer.music.get_busy():
            if self.countdown <= 0:
                ...
                return
            elif (self.player.score["steak"] >= OBJECT_1_NEEDS_LEVEL_5
                and self.player.score["toilet_paper"] >= OBJECT_2_NEEDS_LEVEL_5):
