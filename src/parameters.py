...
RATIO_OBJECT_1_LEVEL_3 = RATIO_NEW_OBJECT_LEVEL_3 + ((1 - RATIO_NEW_OBJECT_LEVEL_3) * 0.3)
RATIO_OBJECT_2_LEVEL_3 = RATIO_OBJECT_1_LEVEL_3 + ((1 - RATIO_NEW_OBJECT_LEVEL_3) * 0.3)
RATIO_BAD_OBJECT_LEVEL_3 = RATIO_OBJECT_2_LEVEL_3 + ((1 - RATIO_NEW_OBJECT_LEVEL_3) * 0.4)
OBJECT_1_NEEDS_LEVEL_3 = 20
OBJECT_2_NEEDS_LEVEL_3 = 20

# Level 4
RATIO_NEW_OBJECT_LEVEL_4 = 0.03
RATIO_OBJECT_1_LEVEL_4 = RATIO_NEW_OBJECT_LEVEL_4 + ((1 - RATIO_NEW_OBJECT_LEVEL_4) * 0.3)
RATIO_OBJECT_2_LEVEL_4 = RATIO_OBJECT_1_LEVEL_4 + ((1 - RATIO_NEW_OBJECT_LEVEL_4) * 0.3)
RATIO_BAD_OBJECT_LEVEL_4 = RATIO_OBJECT_2_LEVEL_4 + ((1 - RATIO_NEW_OBJECT_LEVEL_4) * 0.4)
