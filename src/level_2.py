...
class Level2Introduction(Scene):
    def __init__(self):
        ...
        self.chat = []
        self.chat.append(pygame.transform.scale(load_image("assets/images/scenes/2-0.png"), CHAT_SURFACE))
        self.current_chat = -1
...
class Level2Play(Scene):
    def __init__(self):
        Scene.__init__(self)
        self.music = "assets/music/Phillip_Gross_-_04_-_Silver_Danger.mp3"
    ...
    def on_update(self, time):
        ...
        if pygame.mixer.music.get_busy():
            if self.countdown <= 0:
                ...
                return
            elif (self.player.score["steak"] >= OBJECT_1_NEEDS_LEVEL_2
                and self.player.score["toilet_paper"] >= OBJECT_2_NEEDS_LEVEL_2):
